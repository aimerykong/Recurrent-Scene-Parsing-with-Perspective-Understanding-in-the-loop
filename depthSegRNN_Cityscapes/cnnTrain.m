...
%         stats.val(epoch) = cityscapes_processEpoch(net, state, opts.scalingFactor, opts, 'val', opts.numEpochs) ;
        [stats.train(epoch),prof] = cityscapes_processEpoch(net, state, opts.scalingFactor, opts, 'train', opts.numEpochs) ;
        stats.val(epoch) = cityscapes_processEpoch(net, state, opts.scalingFactor, opts, 'val', opts.numEpochs) ;
        ...
        spmd
            ...
            [stats_.train, prof_] = cityscapes_processEpoch(net_, state, opts.scalingFactor, opts, 'train') ;
            stats_.val = cityscapes_processEpoch(net_, state, opts.scalingFactor, opts, 'val') ;
